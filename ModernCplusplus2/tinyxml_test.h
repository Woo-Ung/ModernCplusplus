...
void TinyXMLTest()
{
	...
	m.AddDropItem({ "≥Ø∞≥", 5 });
	m.AddDropItem({ "º’≈È", 10 });
	monsters.push_back(m);

	SaveToXML("C:/Users/ehddn/Desktop/C#/ModernCplusplus/FileSystem/Data/monsters.xml", monsters);

	monsters.clear();
	LoadFromXML("C:/Users/ehddn/Desktop/C#/ModernCplusplus/FileSystem/Data/monsters.xml", monsters);
}